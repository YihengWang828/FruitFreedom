...
path = 'E:\\大三下学期\\实训\\提交文档\\spark_script\\spark_script\\taobao'
...
schema = StructType([StructField("category", StringType(), False),StructField("brand", StringType(), False),
...
for dir in dir_list:
    ...
    df.write.jdbc("jdbc:mysql://localhost:3306/ffdbs", 'all_category', 'append', prop)

all_category_df.show(10)
# all_category_df.repartition(1).write.csv('file:///home/huasiyu/request')
'''
    prop = {}
