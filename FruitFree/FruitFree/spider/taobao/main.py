...
from config import *
#from spider.taotao.taotaoCrawl.config import *
import requests
import hashlib
import time
...
if __name__ == "__main__":
    type_all="水果 青枣 木瓜 哈密瓜 菠萝 蜜桔 鸭梨 猕猴桃 芒果 榴莲 柠檬 金丝枣 脐橙 梨 红提子 桃子 草莓 甘蔗 柑橘 柚子 西瓜 葡萄 香蕉 石榴 山楂 李子 车厘子 水蜜桃 苹果 金桔 枇杷 荔枝 龙眼 椰子 樱桃 蓝莓 柿子 杨梅 毛桃"
    types=str(type_all).split(' ')
    print(len(types))
    for t in types:
        str_searchContent=t
